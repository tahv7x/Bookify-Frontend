...
const Home: React.FC = () => {
  ...
  const categories = [
    { name: 'Santé & médical', icon: Hospital },
    { name: 'Beauté & Bien-être', icon: Sparkles },
    { name: 'Services professionnels', icon: Briefcase },
    { name: 'Services techniques', icon: Wrench }
  ];
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0B0F19] transition-colors duration-200">
      ...
      <main className="min-h-screen relative bg-dot-pattern pb-20 md:pb-0">
        ...
        {/* Hero & Categories */}
        <section id="Categories" className="pt-12 pb-6 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="flex flex-col items-center text-center mb-8 animate-fade-up">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold font-fraunces text-gray-900 dark:text-white tracking-tight mb-4">
          ...
          {/* Categories */}
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 pb-4 pt-2 w-full">
            {categories.map((cat, idx) => {
              ...
              return (
                <button
                  ...
                  className={`group flex flex-col items-center justify-center gap-3 px-5 py-4 rounded-2xl border transition-all duration-300 min-w-[120px]
                      ${isSelected
                      ...
                      : 'glass-card hover:text-[#1A6FD1] dark:hover:text-[#1A6FD1] hover:-translate-y-1 hover:scale-[1.02]'
                    }`}
                >
                  ...
                  <span className={`text-xs font-semibold whitespace-nowrap transition-colors duration-300 ${isSelected ? 'text-white' : 'text-gray-700 dark:text-gray-200 group-hover:text-[#1A6FD1] dark:group-hover:text-[#1A6FD1]'}`}>
                    {cat.name}
                  </span>
                </button>
              );
        ...
        <section className="pb-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto flex flex-wrap justify-center gap-6" style={{ perspective: '1200px' }}>
        ...
        {/* Specialists */}
        <section id="specialists" className="py-16 px-4 sm:px-6 lg:px-8 border-t border-slate-200/50 dark:border-[#2d3148]/50 bg-white/30 dark:bg-[#1a1d27]/20 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col sm:flex-row justify-between items-end mb-8 gap-4">
              ...
              <button onClick={() => navigate('/Explore')} className="group text-sm font-semibold text-[#1A6FD1] hover:text-[#0c5a7c] flex items-center gap-1 transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {specialistsLoading
                ? [1, 2, 3].map(i => (
                  <div key={i} className="rounded-3xl glass-card p-6 animate-pulse">
                ...
                : specialists.map((sp, idx) => (
                  <div key={idx} onClick={() => navigate(`/Service-Provider-Profile/${sp.id}`)} className="group cursor-pointer rounded-3xl glass-card p-6 relative overflow-hidden">
                    ...
                    <div className="flex items-center justify-between pt-5 border-t border-slate-200 dark:border-[#2d3148]/60">
                      ...
                      <button
                        onClick={e => { e.stopPropagation(); navigate(`/Service-Provider-Profile/${sp.id}`); }}
        ...
        {/* Features */}
        <section id="services" className="py-16 px-4 sm:px-6 lg:px-8 border-t border-gray-200 dark:border-white/5">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((f, idx) => {
                const Icon = f.icon;
                return (
                  <div key={idx} className="flex flex-col items-start p-6 rounded-2xl glass-card">
        ...
        {/* CTA */}
        <section className="py-16 px-4 sm:px-6 lg:px-8 border-t border-slate-200/50 dark:border-[#2d3148]/50">
          <div className="max-w-5xl mx-auto relative overflow-hidden rounded-[2.5rem] glass-card p-10 sm:p-20 text-center">
