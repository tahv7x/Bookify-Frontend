    ...
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-[#0B0F19] transition-colors duration-200">
      <style>{`
        ...
        * { font-family:'Poppins',-apple-system,BlinkMacSystemFont,sans-serif; }
        ...
        /* ── CARD ── */
        .card{background:#fff;border-radius:16px;border:1px solid #e5e7eb; transition: all 0.3s ease;}
        .card:hover{transform: translateY(-2px); box-shadow: 0 10px 20px -10px rgba(26,111,209,0.15);}
        .dark .card{background:#151B2B;border-color:transparent;}
        .dark .card:hover{box-shadow: 0 10px 20px -10px rgba(0,0,0,0.4);}
      ...
      <main className={`min-h-screen bg-dot-pattern transition-all duration-300 lg:${isSidebarOpen?'ml-64':'ml-0'}`}>
        <TopBar userName={userName} onMenuToggle={()=>setIsSidebarOpen(!isSidebarOpen)} isMobileMenuOpen={isSidebarOpen} />

        <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col lg:flex-row justify-center gap-6 lg:gap-10 relative z-10">
