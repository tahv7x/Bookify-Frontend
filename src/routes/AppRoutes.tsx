...
import SupportP from "../pages/Provider/SupportP";
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      <Routes location={location} key={location.pathname}>
        ...
        <Route
          path="/Service-Provider-Profile/:providerId"
          element={
            <PageWrapper>
        ...
        <Route
          path="/Home-Provider"
          element={
            <ProtectedRoute allowedRole="PRESTATAIRE">
              <PageWrapper>
                <ProviderLayout>
                  <HomeP />
                </ProviderLayout>
